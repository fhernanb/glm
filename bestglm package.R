...
# Creando la matriz X y el vector y
full_form <- formula(price ~ -1 + beds + baths + size + taxes + new +
...
bestAIC <- bestglm(Xy, IC="AIC", method="exhaustive",
                   family=Gamma, TopModels=2)
