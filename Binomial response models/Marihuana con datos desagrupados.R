...
fit0 <- glm(resp ~ 1, family=binomial, data=datos)
fit1 <- glm(resp ~ gender, family=binomial, data=datos)
fit2 <- glm(resp ~ race, family=binomial, data=datos)
fit3 <- glm(resp ~ gender + race, family=binomial, data=datos)
